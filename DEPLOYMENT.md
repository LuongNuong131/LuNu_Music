...
Gemini output được yêu cầu ở dạng JSON gồm câu trả lời, mood và danh sách `song_id`; backend lọc lại toàn bộ recommendation theo catalog Supabase trước khi trả về frontend. Vì vậy AI không thể tạo ra URL audio hoặc bài hát ngoài thư viện để frontend phát tùy ý. Nút **AI Concierge** mở panel chat, mỗi recommendation có **Phát ngay** và **Thêm vào hàng đợi**.
